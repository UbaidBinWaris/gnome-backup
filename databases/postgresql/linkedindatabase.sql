...
\restrict dxqgKKdqLMZstwmUg7QnFSmpghZdIzeXcgr9WQ8uH3RvlfY2K2KiBAa9OEHxrN9
...
COPY public.linkedin_comments (id, "postId", "commenterName", "commenterUrl", "commentText", likes, "createdAt") FROM stdin;
\.
...
COPY public.linkedin_posts (id, "profileId", "postText", "postType", reactions, comments, reposts, "postedAt", "scrapedAt") FROM stdin;
\.
...
ALTER TABLE ONLY public.linkedin_posts
    ADD CONSTRAINT "linkedin_posts_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES public.linkedin_profiles(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
\unrestrict dxqgKKdqLMZstwmUg7QnFSmpghZdIzeXcgr9WQ8uH3RvlfY2K2KiBAa9OEHxrN9
